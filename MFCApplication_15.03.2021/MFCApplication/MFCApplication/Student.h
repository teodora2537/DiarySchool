...
public:
	...
	void AverageScoreBySubject(map<vector<CString>, vector<CString>>& m_mapAverageScoreBySub);
	...
	//void remedialExaminationBySubject(map<int, vector<CString>>& mapAverageScore);
	void remedialExaminationBySubject(map<vector<CString>, CString>& mapAverageScore);
	void remedialExaminationByMoreSubjects(vector<CString>& m_vecStudentsName);
	int CountStudent();
	void AverageScore(map<vector<CString>, vector<int>>& mapAllScoreBySub);
};
