...
CScoreDlg::CScoreDlg(CScoreData& oScore, const DialogMode eMode)
	: CDialogEx(IDD_DIALOG_SCORE, NULL)
	, m_oScore(oScore)
	, m_eMode(eMode)
{
}
...
void CScoreDlg::DoDataExchange(CDataExchange* pDX)
{
	...
	DDX_Text(pDX, IDC_EDIT_SCORE_STUDENT_ID, m_strStudentID);
...
void CScoreDlg::FillEditBoxes()
{
	...
	SetDlgItemText(IDC_EDIT_SCORE_STUDENT_ID, m_strStudentID);
...
void CScoreDlg::EnableDisableBoxes()
{
	...
	GetDlgItem(IDC_EDIT_SCORE_STUDENT_ID)->EnableWindow(FALSE);
