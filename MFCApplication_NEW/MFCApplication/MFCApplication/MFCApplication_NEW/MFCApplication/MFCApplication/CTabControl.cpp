...
void CTabControl::Init(void)
{
    ...
    m_tabPages[0]->Create(IDD_DIALOG_TAB_STUDENT, this);
    m_tabPages[1]->Create(IDD_DIALOG_TAB_SUBJECT, this);
    m_tabPages[2]->Create(IDD_DIALOG_TAB_SCORE, this);
    m_tabPages[3]->Create(IDD_DIALOG_TAB_REFERENCES, this);
